...
const AddNewPizza = () => {
  ...
  return (
    <div>
      ...
      {success && <Success success="Recipe Added Successfully" />}
        ...
        <Row className="mb-3">
          ...
          <Row className="mb-3 mt-3">
            <Form.Group as={Col} controlId="formGridCity">
              <Form.Label>Small Serving Price</Form.Label>
              <Form.Control
                type="text"
                value={smallPrice}
            ...
            <Form.Group as={Col} controlId="formGridState">
              <Form.Label>Medium Serving Price</Form.Label>
              <Form.Control
                type="text"
                value={mediumPrice}
                onChange={(e) => setmediumPrice(e.target.value)}
                placeholder="Enter Medium Serving Price"
              />
            </Form.Group>
